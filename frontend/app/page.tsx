...
export default function Home() {
  ...
  return (
    <main className="min-h-screen px-6 py-10 sm:px-12 xl:px-20">
      <div className="mx-auto max-w-7xl space-y-10">
        <header className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex items-center gap-3 lg:flex-col lg:items-end lg:gap-2">
            <button
              ...
              disabled={isBusy}
              className="px-4 py-2 rounded border border-paper/30 text-sm font-medium text-paper hover:bg-panel-raised disabled:opacity-40 disabled:hover:bg-transparent transition-colors whitespace-nowrap"
            >
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1.6fr_1fr] lg:items-start">
          <DealList
            deals={deals}
